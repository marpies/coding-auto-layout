...
class TweetView: UIView {
    ...
    private func setupView() {
        ...
        NSLayoutConstraint.activate([
            self.avatarView.leadingAnchor.constraint(equalTo: self.leadingAnchor),
            self.avatarView.topAnchor.constraint(equalTo: self.topAnchor),
            self.avatarView.widthAnchor.constraint(equalToConstant: 60),
            self.avatarView.heightAnchor.constraint(equalToConstant: 60),
            self.avatarView.bottomAnchor.constraint(lessThanOrEqualTo: self.bottomAnchor)
        ])
